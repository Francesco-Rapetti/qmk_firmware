...
// layer 1 Mac Fn
[1] = LAYOUT(
	_______, 	KC_F1,  	KC_F2,  	KC_F3, 		KC_F4,  	KC_F5,  	KC_F6,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	TG(4),	    _______,
	...
	_______,				_______,   	_______,   	_______,  	_______,    _______,   	_______,	MO(8), 		RGB_SPD,	RGB_SPI,	_______,	_______,	RGB_VAI,
...
// layer 1 win Fn
[3] = LAYOUT(
	_______, 	KC_F1,  	KC_F2,  	_______, 	_______,  	_______,  	_______,  	KC_F7,  	KC_F8,  	KC_F9, 	    KC_F10, 	KC_F11, 	KC_F12, 	TG(6),  	_______,
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	_______,	_______,
	RGB_TOG,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,	_______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	_______,                _______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   	_______,	MO(8), 		RGB_SPD,	RGB_SPI,	_______,	_______,	RGB_VAI,
...
[4] = LAYOUT(
	...
	KC_CAPS,	KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	KC_ENT,                 LNK_BLE3,
	KC_LSFT,				KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,	KC_UP,
	KC_LCTL,	KC_LOPT,	KC_LCMD,										KC_SPC, 							KC_RCMD,	MO(5),   				KC_LEFT,	KC_DOWN,    KC_RIGHT),
// layer 2 Mac Fn
[5] = LAYOUT(
	_______, 	KC_BRID,  	KC_BRIU,  	MAC_TASK, 	MAC_SEARCH, MAC_VOICE,  MAC_DND,  	KC_MPRV,  	KC_MPLY,  	KC_MNXT, 	KC_MUTE, 	KC_VOLD, 	KC_VOLU, 	TG(4),	    _______,
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	_______,	_______,
	RGB_TOG, 	_______,   	_______,   	_______,   	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,	_______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	_______,                _______,
	_______,				_______,   	_______,   	_______,  	_______,    _______,   	_______,	MO(8), 		RGB_SPD,	RGB_SPI,	_______,	_______,	RGB_VAI,
...
[6] = LAYOUT(
	...
	KC_CAPS,	KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	KC_ENT, 	           LNK_BLE3,
	KC_LSFT,				KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,    KC_UP,
	KC_LCTL,	KC_LWIN,	KC_LALT,										KC_SPC, 							KC_RALT,	MO(7),	                KC_LEFT,   	KC_DOWN,	KC_RIGHT),
// layer 2 win Fn
[7] = LAYOUT(
	_______, 	KC_BRID,  	KC_BRIU,  	_______, 	_______,  	_______,  	_______,  	KC_MPRV,  	KC_MPLY,  	KC_MNXT, 	KC_MUTE, 	KC_VOLD, 	KC_VOLU, 	TG(6),	    _______,
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	_______,	_______,
	RGB_TOG,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,	_______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	_______,                _______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   	_______,	MO(8), 		RGB_SPD,	RGB_SPI,	_______,	_______,	RGB_VAI,
	_______,	_______,	_______,										_______, 							_______,	MO(7),					RGB_MOD,    RGB_VAD,	RGB_HUI),
// layer side led fn+m
[8] = LAYOUT(
